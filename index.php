    ...
    <div class="modal-dialog modal-md" role="document">
      ...
      <div class="modal-footer">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 -GALAXY HOTEL | <a href="https://www.galaxyhotel.com/" target="_blank">Galaxy Hotel</a></div></div>
            </footer>
